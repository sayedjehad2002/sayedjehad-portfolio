...
export function AccessibleMenu() {
  ...
  const item =
    'block w-full rounded-lg bg-white/10 px-3 py-2 text-left font-sans text-body font-semibold text-white no-underline outline-none transition-colors hover:bg-white/20 focus-visible:ring-2 focus-visible:ring-teal';
  ...
  return (
    ...
    >
      <h1 className="mb-1 font-pixel text-ui leading-tight text-white">Sayed Jehad · Developer's World</h1>
      <p className="mb-2 font-sans text-label text-on-dark-faint">
