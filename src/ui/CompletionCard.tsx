...
const CV = import.meta.env.BASE_URL + 'source/sayed-jehad-cv.pdf';
...
export function CompletionCard() {
  ...
  return (
    <ModalShell onClose={mark} labelledBy="done-title" width="max-w-md">
      <span className="animate-pulse font-pixel text-eyebrow uppercase tracking-widest text-teal-deep">You&apos;ve seen it all</span>
      <h2 id="done-title" className="title-sheen mb-2 mt-2 font-sans text-display font-bold leading-tight text-ink">Thanks for exploring</h2>
      <p className="font-sans text-ui leading-relaxed text-ink-soft">
      ...
      <div className="mt-5 flex flex-wrap items-center gap-2.5">
        <PrimaryLink href={CV} download>
          Download CV
        </PrimaryLink>
        <SecondaryLink href={EMAIL}>
          Email
        </SecondaryLink>
        <SecondaryLink href={LINKEDIN} target="_blank" rel="noreferrer">
          LinkedIn
        </SecondaryLink>
      </div>
    </ModalShell>
